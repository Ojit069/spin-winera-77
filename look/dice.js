...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-27fec907');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-27fec907');}
...
var brandEl=document.querySelector('.rl-brand-27fec907');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
